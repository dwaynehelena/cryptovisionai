...
CORE_REQUIREMENTS = {
    ...
    "plotly": "5.13.0",
    "matplotlib": "3.9.4",  # Added for data visualization and analysis
    ...
    "xgboost": "1.7.4",      # Added xgboost to core requirements
    "lightgbm": "3.3.5",     # Added lightgbm to core requirements
