...
You currently have 1 API Key(s) registered for this user:

Key Type	Description	Permissions	
HMAC-SHA-256	crypto	TRADE, USER_DATA, USER_STREAM	   
Generate HMAC-SHA-256 Key

Register Public Key (for advanced users, see F.A.Q. below)
...
Terms | Privacy | © 2017 - 2025 Binance.com. All rights reserved